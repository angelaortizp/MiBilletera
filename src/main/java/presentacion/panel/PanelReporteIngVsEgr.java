...
public class PanelReporteIngVsEgr extends javax.swing.JPanel {
    ...
    private ControladorReporteIngVsEgr controlador;

    /**
     * Creates new form PanelReporteIngVsEgr
     */
    public PanelReporteIngVsEgr(Modelo modelo) {
        super();
        this.controlador = new ControladorReporteIngVsEgr(this);
        this.modelo = modelo;
        initComponents();
    }
    ...
    public ControladorReporteIngVsEgr getControlador() {
        return controlador;
    }
}
