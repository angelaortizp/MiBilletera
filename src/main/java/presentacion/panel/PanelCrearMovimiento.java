 ...
 * @author rfcas
 */
public class PanelCrearMovimiento extends javax.swing.JPanel implements ActionListener {
     ...
     */
    public PanelCrearMovimiento(Vista vista) {
        super();
        this.vista = vista;
        initModels();
        initComponents();
    ...
    private void initModels(){
        this.tipoCategoriaModel = new TipoCategoriaModel(this.vista.getModelo());
        this.categoriaModel     = new CategoriaModel(this.vista.getModelo());
        this.cuentaModel        = new CuentaModel(this.vista.getModelo(), this.cuenta);        
    }
    ...
    private void initComponents() {
        ...
        jComboBoxCategoria.addActionListener(this);
        ...
        jButtonCrearMovimiento.addActionListener(this.vista.getControlador());
    ...
    public void actionPerformed(ActionEvent e) {
        if("comboBoxEdited".equals(e.getActionCommand())){
            ActionEvent ae = new ActionEvent(this, e.getID(), Eventos.CREAR_CATEGORIA.toString());
            this.vista.getControlador().actionPerformed(ae);
        }
    }
}
